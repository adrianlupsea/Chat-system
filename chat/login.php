...
if(isset($_POST['name']) && !isset($display_case)){
 ...
 if(!isset($ermsg)){
?>
 <h1>Please insert a name</h1>
 <p>You must provide a name for chatting. This name will be visible to other users.</p>
 <form action="index.php" method="POST">
  <div><h3>Your Name :</h3>
  <input class="form-control" name="name" placeholder="A Name Please"/>
  </div>
  <button class="btn btn-success" >Submit & Start Chatting</button>
 </form>
<?php
 }else{
  echo $ermsg;
